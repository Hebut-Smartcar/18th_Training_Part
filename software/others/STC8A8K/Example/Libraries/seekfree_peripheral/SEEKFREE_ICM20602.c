 ...
 * @note		
					...
					------------------------------------ 
						模块管脚            单片机管脚
						SPC                 查看SEEKFREE_ICM20602.c文件中的ICM20602_SPI_SCLK_PIN 宏定义
						SDI                 查看SEEKFREE_ICM20602.c文件中的ICM20602_SPI_MOSI_PIN 宏定义
						SDO                 查看SEEKFREE_ICM20602.c文件中的ICM20602_SPI_MISO_PIN 宏定义
						CS                  查看SEEKFREE_ICM20602.c文件中的ICM20602_SPI_CS_PIN   宏定义
					------------------------------------ 
 ********************************************************************************************************************/
