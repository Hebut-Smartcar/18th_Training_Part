...
//------------------------软件SPI--------------------------//
#define ABS_ENCODER_SCK_PIN   P77   //接模块 SCLK
#define ABS_ENCODER_MISO_PIN  P76  	//接模块 MISO
#define ABS_ENCODER_MOSI_PIN  P75   //接模块 MOSI
#define ABS_ENCODER_CSN_PIN   P54   //接模块 CS
...
#define ABS_ENCODER_SPI_SCK_PIN   	SPI3_SCLK_P77   	//接模块 SCLK
#define ABS_ENCODER_SPI_MISO_PIN  	SPI3_MISO_P76  		//接模块 MISO
#define ABS_ENCODER_SPI_MOSI_PIN  	SPI3_MOSI_P75   	//接模块 MOSI
#define ABS_ENCODER_SPI_CS_PIN   	P54    				//接模块 CS
